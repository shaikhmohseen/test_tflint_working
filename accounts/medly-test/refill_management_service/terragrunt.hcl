...
inputs = {
  ...
  rms_report_sender_email           = "no-reply@refill-management-test.medly.io"
  rms_ses_domain                    = "refill-management-test.medly.io"
  ...
  private_subnets                   = ["10.123.0.0/24", "10.123.1.0/24"]
  public_subnets                    = ["10.123.2.0/24", "10.123.3.0/24"]
  database_subnets                  = ["10.123.4.0/24", "10.123.5.0/24"]
