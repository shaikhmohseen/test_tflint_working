...
variable "provisioned_concurrency_count" {
  type        = number
  default     = 0
  description = "provisioned concurrency for the lambda"
}

variable "dph_uploads_s3_bucket_arn" {
  type        = string
  description = "Delivery Hosptials Service uploads s3 bucket arn"
}

variable "dph_uploads_s3_bucket_name" {
  type        = string
  description = "Delivery Hosptials Service uploads s3 bucket name"
}
