...
variable "db_rds_username" {
  ...
  type        = string
  default     = "particle_health_service_user"
}

variable "db_rds_password" {
  description = "RDS password"
  type        = string
  default     = "particle_health_service_password"
}

variable "db_rds_dbname" {
  description = "RDS Database Name"
  type        = string
  default     = "particle_health_service_db"
}
...
variable "ph_uploads_s3_bucket_arn" {
  type        = string
  description = "Particle Health uploads s3 bucket arn"
}

variable "ph_uploads_s3_bucket_name" {
  type        = string
  description = "Particle Health uploads s3 bucket name"
}
