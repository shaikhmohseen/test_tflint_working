...
variable "db_rds_username" {
  ...
  type        = string
  default     = "insurance_service_user"
}

variable "db_rds_password" {
  description = "RDS password"
  type        = string
  default     = "insurance_service_password"
}

variable "db_rds_dbname" {
  description = "RDS Database Name"
  type        = string
  default     = "insurance_service_db"
}
...
variable "ins_uploads_s3_bucket_arn" {
  type        = string
  description = "Insurance Service uploads s3 bucket arn"
}

variable "ins_uploads_s3_bucket_name" {
  type        = string
  description = "Insurance Service uploads s3 bucket name"
}
