terraform {
  source = "../../../modules/services//rx_suggestion_service"
}
...
inputs = {
  ...
  private_subnets                   = ["10.26.0.0/24", "10.26.1.0/24"]
  public_subnets                    = ["10.26.2.0/24", "10.26.3.0/24"]
  database_subnets                  = ["10.26.4.0/24", "10.26.5.0/24"]
  db_rds_username                   = "rx_suggestion_service_user"
  db_rds_dbname                     = "rx_suggestion_service_db"
  rds_max_capacity                  = 2
  rds_min_capacity                  = 2
  rds_auto_pause                    = false
  bastion_aws_key_pair_name         = "rx_suggestion_service_bastion"
