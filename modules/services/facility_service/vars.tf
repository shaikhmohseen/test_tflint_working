...
variable "db_rds_username" {
  ...
  type        = string
  default     = "facility_service_user"
}

variable "db_rds_password" {
  description = "RDS password"
  type        = string
  default     = "facility_service_password"
}

variable "db_rds_dbname" {
  description = "RDS Database Name"
  type        = string
  default     = "facility_service_db"
}
...
variable "fs_uploads_s3_bucket_arn" {
  type        = string
  description = "Facility Service uploads s3 bucket arn"
}

variable "fs_uploads_s3_bucket_name" {
  type        = string
  description = "Facility Service uploads s3 bucket name"
}
