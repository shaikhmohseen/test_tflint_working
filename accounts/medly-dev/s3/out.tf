...
output "ph_uploads_s3_bucket_arn" {
  value = aws_s3_bucket.ph_uploads.arn
}

output "ph_uploads_s3_bucket_name" {
  value = aws_s3_bucket.ph_uploads.bucket
}
...
output "terraform_module_artifacts_s3_location_arn" {
  value = "${aws_s3_bucket.build_artifacts.arn}/terraform-modules"
}
