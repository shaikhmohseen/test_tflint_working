terraform {
  source = "../../../modules/services//particle_health_service"
}
...
inputs = {
  ...
  ph_uploads_s3_bucket_arn          = dependency.s3.outputs.ph_uploads_s3_bucket_arn
  ph_uploads_s3_bucket_name         = dependency.s3.outputs.ph_uploads_s3_bucket_name
  ...
  private_subnets                   = ["10.159.0.0/24", "10.159.1.0/24"]
  public_subnets                    = ["10.159.2.0/24", "10.159.3.0/24"]
  database_subnets                  = ["10.159.4.0/24", "10.159.5.0/24"]
  db_rds_username                   = "particle_health_service_user"
  db_rds_password                   = "particle_health_service_password"
  db_rds_dbname                     = "particle_health_service_db"
  db_max_capacity                   = 8
  db_min_capacity                   = 2
  db_auto_pause                     = false
  bastion_aws_key_pair_name         = "particle_health_service_bastion"
