...
module "okta_app" {
  ...
  update_env_vars_secret                  = local.update_env_vars_secret
  okta_idp_name                           = var.okta_idp_name
  okta_idp_type                           = local.okta_idp_type
