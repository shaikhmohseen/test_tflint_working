...
variable "cidr_block" {
  description = "CIDR for the watchtower Sevice VPC"
  type        = string
}

variable "private_subnets" {
  description = "CIDR for watchtower Sevice private subnet vpc"
  type        = list(string)
}

variable "public_subnets" {
  description = "CIDRs for watchtower Sevice public subnets"
  type        = list(string)
}

variable "database_subnets" {
  description = "CIDR for watchtower Sevice database subnet vpc"
  type        = list(string)
}
