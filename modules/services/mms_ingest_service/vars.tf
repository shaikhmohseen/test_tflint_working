...
variable "tags" {
  type        = map(string)
  default     = {}
  description = "Tags for MMS-Ingestion Service"
}
...
variable "mms_ingest_table_name" {
  description = "DynamoDB mms-ingest table name"
  type        = string
  default     = "ingest"
}

variable "prescription_table_name" {
  description = "DynamoDB prescription table name"
  type        = string
  default     = "prescription"
}

variable "patient_table_name" {
  description = "DynamoDB patient table name"
  type        = string
  default     = "patient"
}
...
variable "dynamodb_attributes" {
  description = "DynamoDB default attributes"
  type = list(object({
    name = string
    type = string
  }))
...
variable "dynamodb_hash_key" {
  description = "DynamoDB default hash key"
  type        = string
  default     = "id"
}
...
variable "enable_point_in_time_recovery" {
  description = "Flag to enable/disable point-in-time recovery"
  type        = bool
  default     = true
}
