...
variable "dp_uploads_s3_bucket_arn" {
  type        = string
  description = "Delivery Service uploads s3 bucket arn"
}

variable "dp_uploads_s3_bucket_name" {
  type        = string
  description = "Delivery Service uploads s3 bucket name"
}
