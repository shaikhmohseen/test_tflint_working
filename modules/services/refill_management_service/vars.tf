variable "deployment_account" {
  description = "Deployment Account name"
  type        = string
}
...
variable "build_artifacts_bucket_name" {
  type        = string
  description = "Name of the bucket that contains build assets for deployments"
}
...
variable "rms_uploads_s3_bucket_name" {
  type        = string
  description = "Refill Management Service GSDD data bucket name"
}

variable "rms_uploads_s3_bucket_arn" {
  type        = string
  description = "Refill Management Service GSDD data bucket ARN"
}

variable "rms_report_sender_email" {
  type        = string
  description = "Refill Management Service Report Sender Email"
}

variable "rms_ses_domain" {
  type        = string
  description = "Refill Management Service SES Domain"
}
